...
def write(text, size=32):
	font = pygame.font.SysFont('freesanbold.ttf', size)
	text1 = font.render(str(text), True, (37, 37, 37))
	win.blit(text1, (win.get_width() / 2 - text1.get_width() / 2 - cam[0], win.get_height() / 2 - text1.get_height() / 2 - cam[1]))
